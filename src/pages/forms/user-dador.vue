...
<div class="flex fixed flex-center">
		<div class="row justify-center ">
			...
			<p class="text-h6 text-center q-pb-md text-center ">
				Preencha os campos abaixo para poder ser doador 
			</p>
...
export default {
 ...
 mounted(){
		 this.dador.email = this.getUserAuth.email
		 	 	this.dador.nome = this.getUserAuth.name
