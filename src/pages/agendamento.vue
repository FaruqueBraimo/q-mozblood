  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'calories', align: 'center', label: 'Data  Agendanda', field: 'calories', sortable: true , },
        { name: 'fat', label: 'Data de  Agendamento', field: 'Data_Agendamento', sortable: true, style: 'width: 10px' },
        { name: 'carbs', label: 'Hora de Agendamento', field: 'carbs' },
        { name: 'protein', label: 'Observação', field: 'protein' },
